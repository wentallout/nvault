...
<svg
		...
		><g mask="url(#cs_mask_1_misc-1)"
			...
			><g filter="url(#filter0_f_748_5063)"
				><path fill="#00F0FF" fill-opacity="0.85" d="M158 22H15v108h143V22z"></path><path
					fill="#FF58E4"
					d="M209 101H52v116h157V101z"></path
				><ellipse cx="156" cy="80" fill="#FFE500" fill-opacity="0.79" rx="83" ry="57"></ellipse></g
			></g
		></g
	><defs
		><filter
			...
			><feGaussianBlur result="effect1_foregroundBlur_748_5063" stdDeviation="30"></feGaussianBlur
			></filter
	...
	><defs
		><filter
			...
			><feComposite in="out1" in2="SourceGraphic" operator="in" result="out2"></feComposite><feBlend
				in="SourceGraphic"
				in2="out2"
				mode="overlay"
				result="out3"></feBlend
